...
namespace VolumetricAudio
{
	...
	[ExecuteInEditMode]
	[HelpURL(VA_Helper.HelpUrlPrefix + "VA_Capsule")]
	...
	public class VA_Capsule : VA_VolumetricShape
	{
		...
		public CapsuleCollider CapsuleCollider { set { capsuleCollider = value; } get { return capsuleCollider; } } [FSA("CapsuleCollider")] [SerializeField] private CapsuleCollider capsuleCollider;
		...
		public float Height { set { height = value; } get { return height; } } [FSA("Height")] [SerializeField] private float height = 2.0f;

		/// <summary>The direction of the capsule shape.</summary>
		public int Direction { set { direction = value; } get { return direction; } } [FSA("Direction")] [SerializeField] [VA_Popup("X-Axis", "Y-Axis", "Z-Axis")] private int direction = 1;
