...
namespace VolumetricAudio
{
	...
	[ExecuteInEditMode]
	[HelpURL(VA_Helper.HelpUrlPrefix + "VA_Mesh")]
	...
	public class VA_Mesh : VA_VolumetricShape
	{
		...
		public MeshCollider MeshCollider { set { meshCollider = value; } get { return meshCollider; } } [FSA("MeshCollider")] [SerializeField] private MeshCollider meshCollider;

		/// <summary>If you set this, then all shape settings will automatically be copied from the filter.</summary>
		public MeshFilter MeshFilter { set { meshFilter = value; } get { return meshFilter; } } [FSA("MeshFilter")] [SerializeField] private MeshFilter meshFilter;
		...
		public float MeshUpdateInterval { set { meshUpdateInterval = value; } get { return meshUpdateInterval; } } [FSA("MeshUpdateInterval")] [SerializeField] private float meshUpdateInterval = -1.0f;
		...
		public float RaySeparation { set { raySeparation = value; } get { return raySeparation; } } [FSA("RaySeparation")] [SerializeField] private float raySeparation = 0.1f;
	...
	public class VA_Mesh_Editor : VA_Editor<VA_Mesh>
	{
		protected override void OnInspector()
		{
			...
			if (Any(t => t.IsBaked == true))
			{
				...
				{
					Each(t => t.ClearBake(), true, "Clear Baked Mesh");
				}
