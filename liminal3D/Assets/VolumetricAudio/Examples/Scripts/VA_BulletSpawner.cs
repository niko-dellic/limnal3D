...
namespace VolumetricAudio.Examples
{
	...
	[HelpURL(VA_Helper.HelpUrlPrefix + "VA_BulletSpawner")]
	[AddComponentMenu("Volumetric Audio/VA Bullet Spawner")]
...
namespace VolumetricAudio.Examples
{
	...
	[CustomEditor(typeof(VA_BulletSpawner))]
	public class VA_BulletSpawner_Editor : VA_Editor<VA_BulletSpawner>
	{
